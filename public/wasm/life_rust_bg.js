 ...
 */
export function init_engine(canvas_id) {
 ...
 * @param {any} conf
 */
export function update_conf(conf) {
  try {
    wasm.update_conf(addBorrowedObject(conf));
  } finally {
    heap[stack_pointer++] = undefined;
  }
}
...
export function __wbindgen_closure_wrapper216(arg0, arg1, arg2) {
